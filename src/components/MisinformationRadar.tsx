              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p className="text-sm">
                      {result.source === 'REAL-TIME_DATABASE'
                        ? 'Cross-referenced against known threat vectors using Azure AI Search for maximum speed and accuracy.'
                        : "Deep reasoning trace generated by GPT-4o on Azure for comprehensive contextual understanding."}
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
